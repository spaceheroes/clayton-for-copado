...
declare module "@salesforce/schema/User.TIMBASURVEYS__SurveyReminder__c" {
  const TIMBASURVEYS__SurveyReminder__c:string;
  export default TIMBASURVEYS__SurveyReminder__c;
}
declare module "@salesforce/schema/User.TIMBASURVEYS__reminderStringSize__c" {
  const TIMBASURVEYS__reminderStringSize__c:number;
  export default TIMBASURVEYS__reminderStringSize__c;
}
declare module "@salesforce/schema/User.copado__API_URL__c" {
  const copado__API_URL__c:string;
  export default copado__API_URL__c;
}
declare module "@salesforce/schema/User.copado__Hide_Copado_feedback__c" {
  const copado__Hide_Copado_feedback__c:boolean;
  export default copado__Hide_Copado_feedback__c;
}
declare module "@salesforce/schema/User.copado__Show_Copado_Tips__c" {
  const copado__Show_Copado_Tips__c:boolean;
  export default copado__Show_Copado_Tips__c;
}
declare module "@salesforce/schema/User.copado__Work_Manager_Panels__c" {
  const copado__Work_Manager_Panels__c:string;
  export default copado__Work_Manager_Panels__c;
}
