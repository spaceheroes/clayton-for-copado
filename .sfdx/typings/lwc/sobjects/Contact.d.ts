...
declare module "@salesforce/schema/Contact.Dreamforce__c" {
  const Dreamforce__c:string;
  export default Dreamforce__c;
}
declare module "@salesforce/schema/Contact.TIMBASURVEYS__SurveyReminder__c" {
  const TIMBASURVEYS__SurveyReminder__c:string;
  export default TIMBASURVEYS__SurveyReminder__c;
}
declare module "@salesforce/schema/Contact.TIMBASURVEYS__Survey__r" {
  const TIMBASURVEYS__Survey__r:any;
  export default TIMBASURVEYS__Survey__r;
}
declare module "@salesforce/schema/Contact.TIMBASURVEYS__Survey__c" {
  const TIMBASURVEYS__Survey__c:any;
  export default TIMBASURVEYS__Survey__c;
}
declare module "@salesforce/schema/Contact.TIMBASURVEYS__reminderStringSize__c" {
  const TIMBASURVEYS__reminderStringSize__c:number;
  export default TIMBASURVEYS__reminderStringSize__c;
}
declare module "@salesforce/schema/Contact.Attended_Dreamforce__c" {
  const Attended_Dreamforce__c:string;
  export default Attended_Dreamforce__c;
}
